...
useEffect(()=>{
  ...
  return (<div>
  {cartSideBarState?
   <div className='fixed cursor-pointer  top-0 right-0 left-0 bottom-0 bg-[rgba(0,0,0,.5)]'>
   <div className='absolute py-8 px-5 z-[999] top-0 right-0  h-[100vh] w-[300px] sm:w-[400px] bg-[#fff]'>
     ...
     <button disabled={cart?.length<1 ? true:false }  className='w-[100%] uppercase text-center  mb-3  px-10 py-2  cursor-pointer bg-[#000] hover:bg-[#524F4F] text-[#fff]'>
      Checkout
     </button>
